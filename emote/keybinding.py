...
FORBIDDEN_KEYVALS = [
    ...
    Gdk.KEY_space,
    Gdk.KEY_Mode_switch,
    # numerics currently are recogized only as _End, _Down, etc.. with or without numlock
    Gdk.KEY_KP_0,
    # Gdk checks numlock and parses out the correct key, but this could change, so list
    Gdk.KEY_KP_1,
    # these numerics anyhow. (This may differ depending on kb layouts, locales, etc.. but
    Gdk.KEY_KP_2,
    # I didn't thoroughly check)
    Gdk.KEY_KP_3,
    Gdk.KEY_KP_4,
    Gdk.KEY_KP_5,
    Gdk.KEY_KP_6,
